...
#
# This file is part of SkeletonCharybdis
#
...
OhdsiRTools::checkUsagePackage("SkeletonCharybdis")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
unlink("extras/SkeletonCharybdis.pdf")
shell("R CMD Rd2pdf ./ --output=extras/SkeletonCharybdis.pdf")
